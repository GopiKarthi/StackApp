 ...
 */
public class QuestionsSortByVotes extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.question_sort_by_votes, container, false);
        ...
        listRecyclerView = (RecyclerView) view
                .findViewById(R.id.linear_recyclerview_votes);
...
//						Toast.LENGTH_SHORT).show();
    ...
    public  void PostVolley(int page){
        String JSON_URL = "https://api.stackexchange.com/2.2/questions?page="+page+"&order=desc&sort=votes&site=stackoverflow";
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, JSON_URL, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Log.e("Volley", "Error");
                        spinner.setVisibility(View.GONE);
//                        Toast.makeText(MyApplication.getInstance().getApplicationContext(),"Try After sometime",Toast.LENGTH_SHORT).show();
