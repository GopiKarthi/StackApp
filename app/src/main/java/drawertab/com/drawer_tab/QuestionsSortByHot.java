...
public class QuestionsSortByHot extends Fragment {
...
//						Toast.LENGTH_SHORT).show();
    ...
    public  void PostVolley(int page){
        String JSON_URL = "https://api.stackexchange.com/2.2/questions?page="+page+"&order=desc&sort=hot&site=stackoverflow";
